...
For CI/CD, use the secrets `ATB_WORM_S3_ACCESS_KEY_ID` and
`ATB_WORM_S3_SECRET_ACCESS_KEY` as documented in
[maintainer release guidance](../maintainers/release.md). Map these to the
standard AWS credential environment variables in the workflow.
