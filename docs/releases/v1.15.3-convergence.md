# ATB LOCAL PUBLIC-READINESS REPORT (HISTORICAL CONVERGENCE EVIDENCE)
...
- `docs/README.md`, `docs/concepts/architecture.md`, `docs/concepts/trust-model.md`,
  `docs/public-surface.md`, `docs/roadmap.md`, `docs/getting-started/quickstart.md`, and current
...
- `docs/maintainers/release.md` and `docs/release/*` — current version-neutral release
...
- `docs/concepts/architecture.md` — replaced the fictional shared engine with independent SDK implementations and vectors.
- `docs/evidence/cas.md` — scoped Completeness Assurance Score to profile-visible recorded evidence.
...
- `docs/concepts/glossary.md` — established canonical bundle/event/record/capture/profile/CAS/custody terminology.
- `docs/investigate/incidents.md` — scoped deterministic findings and emphasized hash-addressed evidence.
...
- `docs/evidence/profiles.md` — described profiles as ATB evidence obligations, not compliance certification.
...
- `docs/getting-started/quickstart.md` — clarified the CLI-first path and full-source viewer distinction.
- `docs/maintainers/release.md` — made version truth and the automated release workflow authoritative.
...
- `docs/concepts/trust-model.md` — documented implemented bounds, accepted limits, and honest trust claims.
- `docs/maintainers/support-matrix.md` — updated supported Go and installation/package distinctions.
...
- `docs/releases/v1.15.3-convergence.md` — records the truth map, acceptance evidence, blockers, and controlled publication plan.
...
gh pr create --repo pcguest/atb \
  ...
  --body-file docs/releases/v1.15.3-convergence.md
```
...
CodeQL/Docker-image results. Then follow `docs/maintainers/release.md` from updated `main`:
...
# Edit CHANGELOG.md and every version marker listed in docs/maintainers/release.md.
