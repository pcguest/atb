...
func printIncidentUsage(w io.Writer) {
	fmt.Fprint(w, `atb incident report --bundle <path> --session <id> [--format markdown|json]

Build a session-scoped forensic report over a captured ATB bundle.

The full signed bundle remains the authoritative, tamper-evident evidence; this
