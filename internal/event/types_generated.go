...
var EventTypesGenerated = []EventTypeSpecGenerated{
	...
	{Type: TypeRAGIndex, Description: "PageIndex document tree build record (index_hash, node_count)", Profiles: []string{"atb.profile.rag_answer"}, Criticality: "required", RequiredFields: []string{"index_id", "index_version", "tree_root_digest", "node_count"}},
	{Type: TypeRAGRetrieval, Description: "PageIndex reasoning-based retrieval result (node_id, page_start/end)", Profiles: []string{"atb.profile.rag_answer"}, Criticality: "required", RequiredFields: []string{"retrieval_id", "index_id", "selected_node_ids", "result_set_digest"}},
...
var RequiredFieldsGenerated = map[string][]string{
	...
	TypeRAGIndex:                   []string{"index_id", "index_version", "tree_root_digest", "node_count"},
	TypeRAGRetrieval:               []string{"retrieval_id", "index_id", "selected_node_ids", "result_set_digest"},
